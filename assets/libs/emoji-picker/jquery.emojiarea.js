...
(function($, window, document) {
  ...
  */
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    $textarea.after("<i class='emoji-picker-icon emoji-picker " + this.options.popupButtonClasses + "' data-id='" + id + "' data-type='picker'><svg xmlns=\"http://www.w3.org/2000/svg\" width=\"14.3\" height=\"14.3\" viewBox=\"0 0 14.3 14.3\">\n" +
