...
const createDataTable = (id, config, isFixedCollumns) => {
	...
	const tableWrapper = tableElement && tableElement.closest('.diriq-table__wrapper');
	...
	const filterButton = tableWrapper && tableWrapper.querySelector('.diriq-table__filter-btn');
	const tFootInputsWrapper = tableWrapper && tableWrapper.querySelectorAll('.diriq-table th');
